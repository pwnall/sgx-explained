...
\input{contents/architecture/cache_org.tex}
\input{contents/architecture/coherence.tex}
\input{contents/architecture/out_of_order.tex}
\input{contents/architecture/memory_io.tex}
\input{contents/architecture/tlbs.tex}
