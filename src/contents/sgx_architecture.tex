\HeadingLevelA{Computer Architecture Background}
...
\input{contents/sgx_architecture/overview.tex}
\input{contents/sgx_architecture/resources.tex}
\input{contents/sgx_architecture/rings.tex}
\input{contents/sgx_architecture/addresses.tex}
\input{contents/sgx_architecture/paging.tex}
\input{contents/sgx_architecture/registers.tex}
\input{contents/sgx_architecture/segments.tex}
\input{contents/sgx_architecture/faults.tex}
\input{contents/sgx_architecture/computer.tex}
\input{contents/sgx_architecture/out_of_order.tex}
\input{contents/sgx_architecture/caching.tex}
\input{contents/sgx_architecture/interrupts.tex}
\input{contents/sgx_architecture/booting.tex}
\input{contents/sgx_architecture/microcode.tex}
