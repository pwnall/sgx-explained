...
Figure~\ref{fig:cpu_registers} and Table~\label{fig:xsave_state}. The values in
these registers make up an application thread's state, or
\textit{execution context}.
