...
Intel \textit{Management Engine} (ME)
\cite{ruan2014intelme, ververis2010security}.  The ME runs firmware stored in
the same flash memory chip as the UEFI firmware. The Management Engine is
...
transfers, and can override the CPU boot vector.
