...
The Intel architecture provides no TLB coherence across logical processors. The
kernel is reponsible for flushing the appropriate TLB entries when modifying
the page table, and the hypervisor must perform TLB flushes when modifying the
EPT.
