\subsection{The Hardware Underpinnings of SGX}
...
% TLB invalidation on EEXIT
%   US 8,972,746 B2 - 32:55-67, 33:1-9
...
The SDN~\cite{intel2015sdm} mentions a 16-byte CPU security version number
