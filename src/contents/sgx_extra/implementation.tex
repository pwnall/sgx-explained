...
address translations when a logical processor is in enclave
mode~(\S~\ref{sec:sgx_threads}), or when the physical address produced by the
page walker FSM matches the Processor Reserved
