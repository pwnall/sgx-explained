...
% Packge registers: EPC_BASE / EPC_MASK, EPCM_BASE_OFFSET, EPC_SECS_BASE_OFFSET
%   US 8,972,746 B2 - Table 4-14, column 19
% LP registers: ENCLAVE_MODE, SECS_PA, TCS_LA, TCS_PA, SSA_PA
%   US 8,972,746 B2 - Table 4-15, column 19

From a cost-performance standpoint, the cost of register memory might be
