...
considered a physical attack. Furthermore, a malicious firmware can modify the
system software during the boot process


the computer firmware checks \cite{wojtczuk2010bios, furtak2014bios}
