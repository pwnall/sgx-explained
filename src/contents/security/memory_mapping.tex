...
TODO: Explain that these attacks are only relevant when the system software is
not trusted, i.e. when reasoning about application-level isolation containers.
